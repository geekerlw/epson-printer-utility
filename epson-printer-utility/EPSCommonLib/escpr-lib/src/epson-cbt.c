...
EPS_INT32   cbtCommOpen (
    ...
    debug_msg("start call function epson-cbt.c/cbtCommOpen\n");
...
/*** Open Communication                                                                 */
    if ((Ret = commOpen(devinfo, fd)) != EPCBT_ERR_NONE){
        ...
        debug_msg("exit call function epson-cbt.c/cbtCommOpen err: = %d\n", Ret);
		EPS_RETURN( Ret );
    }

    debug_msg("exit call function epson-cbt.c/cbtCommOpen\n");
...
EPS_INT32   cbtCommChannelOpen (
    ...
    debug_msg("start call function epson-cbt.c/cbtCommChannelOpen \n");
    EPS_INT32 Ret;
    ...
    debug_msg("Exit call function epson-cbt.c/cbtCommChannelOpen \n");
...
EPS_INT32   cbtCommReadData (
    ...
    debug_msg("start call function epson-cbt.c/cbtCommReadData \n");
...
#endif
    debug_msg("Exit call function epson-cbt.c/cbtCommReadData \n");
...
EPS_INT32   cbtCommWriteData (
    ...
    debug_msg("start call function epson-cbt.c/cbtCommWriteData \n");
    EPS_INT32   Ret = EPCBT_ERR_NONE;
    EPS_INT32   Written;
    EPS_INT32   RestSize;
    EPS_UINT8   CBTCh = 0;
    ...
    debug_msg("Exit call function epson-cbt.c/cbtCommWriteData \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT32    commOpen (
    ...
    debug_msg("start call function epson-cbt/commOpen\n");
    EPS_INT32   Ret = EPCBT_ERR_NONE;
    EPS_UINT8   Sid = 0;
    ...
    debug_msg("Exit call function epson-cbt/commOpen\n");
...
static EPS_INT32    commOpenChannel (
    ...
    debug_msg("start call function epson-cbt.c/commOpenChannel \n");
    EPS_INT32   Ret   = EPCBT_ERR_NONE;
    EPS_UINT8   CBTCh = 0;
...
#endif
    debug_msg("Exit call function epson-cbt.c/commOpenChannel \n");
...
static EPS_INT32    commCloseChannel (
    ...
    debug_msg("start call function epson-cbt.c/commCloseChannel \n");
    EPS_INT32   Ret   = EPCBT_ERR_NONE;
    EPS_UINT8   CBTCh = 0;
...
debug_msg("Exit call function epson-cbt.c/commCloseChannel \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT32    commChChange (
    ...
    debug_msg("start call function epson-cbt.c/commChChange \n");
    EPS_INT32   Ret = EPCBT_ERR_NONE;
    ...
    debug_msg("Exit call function epson-cbt.c/commChChange \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT16    EPCBT_Open (
    ...
    debug_msg("start call function epson-cbt.c/EPCBT_Open \n");
    ...
    DebMsgOut(debMsgWork);
#endif
    debug_msg("Exit call function epson-cbt.c/EPCBT_Open \n");
...
static EPS_INT16    EPCBT_Close (
    ...
    debug_msg("start call function epson-cbt.c/EPCBT_Close \n");
    EPS_INT16       Ret = EPCBT_ERR_NONE;
    EPS_INT32       lp1;
    CBTS_CHINFO*    ChPtr;
    ...
    debug_msg("Exit call function epson-cbt.c/EPCBT_Close \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT16    EPCBT_OpenChannel (
    ...
    debug_msg("start call function epson-cbt.c/EPCBT_OpenChannel \n");
    EPS_INT16   Ret     = EPCBT_ERR_NONE;
    ...
    debug_msg("Exit call function epson-cbt.c/EPCBT_OpenChannel \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT16    EPCBT_CloseChannel (
    ...
    debug_msg("start call function epson-cbt.c/EPCBT_CloseChannel \n");
    EPS_INT16       Ret   = EPCBT_ERR_NONE;
    EPS_INT32       lp1;
    ...
    debug_msg("Exit call function epson-cbt.c/EPCBT_CloseChannel \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT16    EPCBT_Write (
    ...
    debug_msg("start call function epson-cbt.c/EPCBT_Write \n");
    EPS_INT16       Ret = EPCBT_ERR_NONE;
    EPS_INT32       Credit;
    EPS_INT32       Size;
    EPS_INT32       Count;
    ...
    debug_msg("Exit call function epson-cbt.c/EPCBT_Write \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT16    CbtReadRtn (
    ...
    debug_msg("start call function epson-cbt.c/CbtReadRtn \n");
    EPS_INT16   Ret    = EPCBT_ERR_NONE;
    EPS_INT32   Ans;
    EPS_INT32   Count  = 0;
    EPS_INT32   lp1;
    ...
    DebMsgOut("\r\n");
#endif
//    debug_msg("Exit call function epson-cbt.c/CbtReadRtn \n");
...
static EPS_INT16    CbtReplyCheck (
    ...
    debug_msg("start call function epson-cbt.c/CbtReplyCheck \n");
    EPS_INT16    Ret = EPCBT_ERR_NONE;
    ...
    debug_msg("Exit call function epson-cbt.c/CbtReplyCheck \n");
...
static EPS_INT16    CbtEpsonPacking (
    ...
    debug_msg("start call function epson-cbt.c/CbtEpsonPacking \n");
    EPS_INT16   Ret     = EPCBT_ERR_NONE;
    EPS_INT16   Ans;
    EPS_INT32   Cnt     = 0;
    ...
    debug_msg("Exit call function epson-cbt.c/CbtEpsonPacking \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT32    CbtOpenChannelCommand (
    ...
    debug_msg("start call function epson-cbt.c/CbtOpenChannelCommand \n");
    EPS_INT32   Ret     = EPCBT_ERR_NONE;
    EPS_INT16   Ans;
    EPS_INT32   Cnt     = 0;
    ...
    *pStPsz = (EPS_UINT32)((RBuff[12] << 8) + RBuff[13]);
    ...
    debug_msg("Exit call function epson-cbt.c/CbtOpenChannelCommand \n");
...
static EPS_INT16    CbtCloseChannelCommand (
    ...
    debug_msg("start call function epson-cbt.c/CbtCloseChannelCommand \n");
    EPS_INT16   Ret     = EPCBT_ERR_NONE;
    EPS_INT16   Ans;
    EPS_INT32   Cnt     = 0;
    ...
    debug_msg("Exit call function epson-cbt.c/CbtCloseChannelCommand \n");
...
static EPS_INT32    CbtCreditReqCommand (
    ...
    debug_msg("start call function epson-cbt.c/CbtCreditReqCommand \n");
    EPS_INT32       Ret     = EPCBT_ERR_NONE;
    EPS_INT16       Ans;
    EPS_INT32       Cnt     = 0;
    ...
    debug_msg("Exit call function epson-cbt.c/CbtCreditReqCommand \n");
    EPS_RETURN( Ret );
}
...
static EPS_INT32    CbtDataWrite (
    ...
    debug_msg("start call function epson-cbt.c/CbtDataWrite \n");
    EPS_INT32   Ret = EPCBT_ERR_NONE;
    EPS_INT16   Ans;
    EPS_INT32   Cnt = 0;
    EPS_UINT32  BuffLen;
    ...
    *(Buff + 5) = 0x01;            /* end data */
    ...
    if (Ret < 0)
        ...
        if ( Ans != EPCBT_ERR_NONE )
            Ret = EPCBT_ERR_WRITEERROR;
    debug_msg("Exit call function epson-cbt.c/CbtDataWrite \n");
...
static EPS_INT16 CbtDataRead (
    ...
    debug_msg("start call function epson-cbt.c/CbtDataRead \n");
    EPS_INT16       Ret   = EPCBT_ERR_NONE;
    EPS_INT16       Ans;
    EPS_INT32       Cnt   = 0;
    EPS_INT32       lp1;
   ...
   for ( lp1 = 0; ; lp1++ ) {
    ...
    debug_msg("Exit call function epson-cbt.c/CbtDataRead \n");
